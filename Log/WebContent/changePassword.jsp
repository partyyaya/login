...
<div class="body">
	...
	<div class="container">		
		<div class="row-fluid margin-bottom-10">
        	<form class="reg-page" action="chPasswd" method='post' onsubmit="return checkAll();">
            	<h3>修改密碼</h3> 
                <div class="controls">           
                    <label>請輸入舊密碼</label>
                    <input type="text" class="span12" name="oldPasswd"/>
                    <label>新密碼 <span id="passwdId"></span></label>
                    <input type="text" class="span12" name="newPasswd" id="newPasswd" onblur="checkPass()"/>
                    <label>確認新密碼<span id="ckId"></span></label>
                    <input type="text" class="span12" id="cknewPasswd" onblur="doubleCheck()"/>                    
                </div>
