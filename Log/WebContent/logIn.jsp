...
<head>
    ...
    <link rel="stylesheet" href="assets/alertify.default.css" />
...
<div class="container">		
	<div class="row-fluid">
        <form class="log-page" action="loginMember" method='post'>
            <h3>登入您的帳號</h3>    
            <div class="input-prepend">
                <span class="add-on"><i class="icon-user"></i></span>
                <input class="input-xlarge" type="text" name='user' placeholder=
                "Account"/>
            </div>
            <div class="input-prepend">
                <span class="add-on"><i class="icon-lock"></i></span>
                <input class="input-xlarge" type="text" name='passwd' placeholder="password" />
            </div>
            <div class="controls form-inline">
                <label class="checkbox"><input type="checkbox" /> 保持登入</label>
